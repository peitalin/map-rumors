...
export class Parallax extends React.Component<ReactProps, any> {
  ...
  handleScroll = (event) => {
    ...
    TweenLite.to('#parallax1', 0, { y: scrollY/2 })
    TweenLite.to('#GeoSearchBar', 0, { y: scrollY/2 })
    TweenLite.to('.mapboxgl-ctrl-top-right', 0, { y: scrollY/2 })
    ...
    if (mapboxContainer) {
      TweenLite.to(mapboxContainer, 0, { y: scrollY/2 })
    }
